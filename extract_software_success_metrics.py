...
get_community_fork_metrics('/home/sv/dup_parameters.csv')

metrics = []
for snapshot_id in snapshots:
    metric = snapshots[snapshot_id]
    if metric.stargazer_counts > 0 and metric.fork_counts > 0:
        metrics.append([metric.url, metric.stargazer_counts,\
...
df.to_csv('/home/sv/community_dup_metrics.csv',index=False,header=True)
