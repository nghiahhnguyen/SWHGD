...
def get_fork_metrics():
    for lines in pd.read_csv('/home/sv/fork_metrics_3.csv', encoding='utf-8', header=None, chunksize=100000):
...
def get_software_health_risk_metrics(filename):
    print(filename)
    cnt = 0
    for lines in pd.read_csv('/home/sv/origin-metrics_3.csv', encoding='utf-8', header=None, chunksize=100000):
        for line in lines.iterrows():
...
get_software_health_risk_metrics('')
...
get_cycle_time_metric('cycle_time_release_3.csv')
